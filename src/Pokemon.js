...
const Pokemon = () => {
    ...
    useEffect( () => {
        if (typeof pokemon !== typeof {}) {
            get(`https://pokeapi.co/api/v2/pokemon/${params.pokemonId}`).then(res => {setPokemon(res.data)})
        } else {
            if (movesPage <= 0) {
                setMovesPage(1);
            }
    ...
    }, [pokemon, params.pokemonId, movesPage] )
    ...
    return (
        <div className='pokemon-container'>
            <div className='pokemon'>
                ...
                <div className = 'pokemon-image-container'><img src = {(typeof pokemon === typeof {}) ? pokemon.sprites.front_default : 'https://i.pinimg.com/originals/44/bd/e7/44bde730a4daa2d1754d296e07ac886d.jpg'} alt = {(typeof pokemon === typeof {}) ? pokemon.name : ''} /></div>
